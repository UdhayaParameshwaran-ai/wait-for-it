...
function CreateNote() {
  ...
  return (
    <form
      ...
      className="w-full px-4 bg-[#D6C7F4] md:px-12 py-6 space-y-6"
    >
      ...
      {/* Sender */}
      <div className="flex flex-col justify-center md:flex-row items-start md:items-center space-y-4 md:space-x-4">
        <label className="w-full md:w-28 mb-1 md:mb-0 text-lg font-medium text-[#50125F]">
          From
        </label>
        <input
          type="text"
          ...
          required
          className="w-120 px-3 py-2 border rounded-full focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm"
        />
      </div>
      ...
      {/* Message */}
      <div className="flex flex-col md:flex-row justify-center items-start md:items-start md:space-x-4">
        <label className="w-full md:w-28 mb-1 md:mb-0 text-lg font-medium text-[#50125F]">
          Message
        </label>
        <textarea
          ...
          required
          rows={3}
          className="w-120 px-3 py-2 border rounded-3xl resize-none focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm"
        ></textarea>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start md:items-center md:space-x-4">
        ...
        <DatePicker
          ...
          timeInputLabel="Time:"
          className="w-120 px-3 py-2 border rounded-full focus:outline-none focus:ring-1 focus:ring-purple-500 text-black text-sm"
